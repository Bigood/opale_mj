...
var scTooltipMgr = {
	...
	xMakeTt: function(pNode, pCo, pTi, pCls, pClsRoot) {
		...
		var vHtml = '<div id="'+pNode.ttId+'" role="tooltip" class="'+this.xBuildCls(pCls,"fra")+(pClsRoot!=''?' '+pClsRoot:'')+'"'+(pNode.fOpt.FIXTYPE!='free' ? ' style="position:absolute;z-index:1010;left:0px;top:0px;width:'+vMaxX+'px;visibility:hidden;text-align:left;"' : '')+'>';
